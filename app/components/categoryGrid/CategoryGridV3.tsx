  ...
  return (
    <section className="relative py-24 px-6 md:px-16">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* TITLE */}
        <h2 className="text-3xl md:text-4xl font-bold mb-14 border-l-4 pl-4 border-[var(--primary)]">
          সব পণ্যের ক্যাটাগরি
        </h2>
          ...
          {categories.map((cat) => {
            ...
            return (
              ...
              >
                {/* HOVER GRADIENT */}
                <div
                  className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${cat.gradient}
